...
* fix: update `setuptools` to 70.0.0 ([`2354a92`](https://github.com/Rebekah-Chuang/VizAble/commit/2354a92145b7fb8bf6ef1ad267a25ecb9b1a9c02))

* fix: upgrade `setuptools` to fix 1 Dependabot alert in `poetry.lock` ([`d66b838`](https://github.com/Rebekah-Chuang/VizAble/commit/d66b838d94ad35a5e95457e91373657818241b8c))

* fix: upgrade `zipp` to fix 1 Dependabot alert in `poetry.lock` ([`1b2859f`](https://github.com/Rebekah-Chuang/VizAble/commit/1b2859f84b59520c19896c155656597f121d6c7d))

* fix: upgrade `certifi` to fix 1 Dependabot alert in `poetry.lock` ([`4ca1d42`](https://github.com/Rebekah-Chuang/VizAble/commit/4ca1d4223c9ab6dc4be78b00888f439c4168f937))

* fix: upgrade `urllib3` to fix 1 Dependabot alerts in `poetry.lock` ([`5335e47`](https://github.com/Rebekah-Chuang/VizAble/commit/5335e47842bc3a652fa002860031b30b6e23f5ff))

* fix: upgrade `tornado` to fix 2 Dependabot alerts in `poetry.lock` ([`4cd4c5d`](https://github.com/Rebekah-Chuang/VizAble/commit/4cd4c5da33ed65d551e45fedcd3b45c78b352791))
